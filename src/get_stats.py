...
if __name__ == "__main__":
    ...
    if args.parse_mode == 'parse':
        descriptive_score_path = f"results/{args.score_prefix}{args.model_name}-descriptive_{args.split}_parse.json"
        reasoning_score_path = f"results/{args.score_prefix}{args.model_name}-reasoning_{args.split}_parse.json"
    elif args.parse_mode == 'qcond_parse':
        descriptive_score_path = f"results/{args.score_prefix}{args.model_name}-descriptive_{args.split}_qcond_parse.json"
        reasoning_score_path = f"results/{args.score_prefix}{args.model_name}-reasoning_{args.split}_qcond_parse.json"
    elif args.parse_mode == 'program_synthesis':
        descriptive_score_path = f"results/{args.score_prefix}{args.model_name}-descriptive_{args.split}_program_synthesis.json"
        reasoning_score_path = f"results/{args.score_prefix}{args.model_name}-reasoning_{args.split}_program_synthesis.json"
    else:
    ...
    if os.path.exists(reasoning_score_path):
        ...
        if args.parse_mode == 'parse':
            json.dump(reasoning_stats, open(f"results/{args.stats_prefix}{args.model_name}-reasoning_{args.split}_parse.json", "w"), indent=4)
        elif args.parse_mode == 'qcond_parse':
            json.dump(reasoning_stats, open(f"results/{args.stats_prefix}{args.model_name}-reasoning_{args.split}_qcond_parse.json", "w"), indent=4)
        elif args.parse_mode == 'program_synthesis':
            json.dump(reasoning_stats, open(f"results/{args.stats_prefix}{args.model_name}-reasoning_{args.split}_program_synthesis.json", "w"), indent=4)
        else:
    ...
    if os.path.exists(descriptive_score_path):
        ...
        if args.parse_mode == 'parse':
            json.dump(descriptive_stats, open(f"results/{args.stats_prefix}{args.model_name}-descriptive_{args.split}_parse.json", "w"), indent=4)
        elif args.parse_mode == 'qcond_parse':
            json.dump(descriptive_stats, open(f"results/{args.stats_prefix}{args.model_name}-descriptive_{args.split}_qcond_parse.json", "w"), indent=4)
        elif args.parse_mode == 'program_synthesis':
            json.dump(descriptive_stats, open(f"results/{args.stats_prefix}{args.model_name}-descriptive_{args.split}_program_synthesis.json", "w"), indent=4)
        else:
